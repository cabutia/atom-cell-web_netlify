export default () => {
    window.init = () => (function(window, document, $, undefined) {
        ...
        window.axlInit = {
            ...
            methods: function(e) {
                window.axlInit.w();
                window.axlInit.contactForm();
                window.axlInit.axilBackToTop();
                window.axlInit.shopFilterWidget();
                window.axlInit.mobileMenuActivation();
                window.axlInit.menuLinkActive();
                window.axlInit.headerIconToggle();
                ...
                window.axlInit.sideOffcanvasToggle('.filter-toggle', '.axil-shop-sidebar');
                window.axlInit.sideOffcanvasToggle('.axil-search', '#header-search-modal');
                window.axlInit.sideOffcanvasToggle('.popup-close, .closeMask', "#offer-popup-modal");
                window.axlInit.stickyHeaderMenu();
                window.axlInit.salActivation();
                window.axlInit.magnificPopupActivation();
                window.axlInit.colorVariantActive();
                window.axlInit.headerCampaignRemove();
                // window.axlInit.offerPopupActivation();
                window.axlInit.axilMasonary();
                window.axlInit.counterUpActivation();
                window.axlInit.scrollSmoth();
               
               
            },
    
            w: function(e) {
                this._window.on('load', window.axlInit.l).on('scroll', window.axlInit.res)
            },
